...
{
    public class Mesa_para_4 : PictureBox , IEventos
    {
        ...
        public Mesa_para_4()
        {
            ...
            this.Width = 100;
            this.Height = 100;
            this.BackgroundImage = Image.FromFile("Resources/Mesa-4-verde.png");
        ...
        public void CambiarColorMesa(string color)
        {
            ...
            switch (color)
            {
                case "Libre":
                    ...
                    break;
                case "Ocupado":
                    this.BackgroundImage = Image.FromFile("Resources/Mesa-4-Rojo.png");

                    break;
                case "Reservado":
                    this.BackgroundImage = Image.FromFile("Resources/Mesa-4-amarillo.png");
