...
{
    public class Mesa_para_2 : PictureBox, IEventos
    {
        ...
        public Mesa_para_2()
        {
            ...
            this.Width = 100;
            this.Height = 100;
            this.BackgroundImage = Image.FromFile("Resources/Mesa-2-verde.png");
        ...
        private void CambiarColorMesa(string color)
        {
            switch (color)
            {
                case "Libre":
                    ...
                    break;
                case "Ocupado":
                    this.BackgroundImage = Image.FromFile("Resources/Mesa-2-Rojo.png");

                    break;
                case "Reservado":
                    this.BackgroundImage = Image.FromFile("Resources/Mesa-2-amarillo.png");
